...
[Установка .NET SDK в Linux и в частности в Ubuntu возможна несколькими способами](https://learn.microsoft.com/ru-ru/dotnet/core/install/linux-ubuntu). Мы воспользуемся самым простым.
...
>Данная команда установки будет работать только в Ubuntu 22.04, и возможно более поздних версиях.
