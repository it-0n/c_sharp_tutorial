...
Эти символы используются для форматирования строк и включения специальных символов без их прямого отображения в тексте. Полный список можно найти в [официальной документации](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/tokens).
