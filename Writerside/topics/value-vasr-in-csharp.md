...
## Операции над кортежами в C#: {id="c_2"}
...
### Ещё раз на пальцах обясняю.
Представь, что ты ведёшь таблицу с результатами проверки навыков падаванов. У тебя есть список учеников, и ты хочешь записать, прошёл ли падаван проверку:
