...
class Program
{
    unsafe static void Main()
    {
        ...
        Half halfNumber = 1.23f; // Тип Half
        Int128 int128Number = 12345678901234567890123456789012345678; // Тип Int128
        UInt128 uint128Number = 12345678901234567890123456789012345678; // Тип UInt128
