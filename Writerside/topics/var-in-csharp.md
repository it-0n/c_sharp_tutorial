...
2. **Реальный пример (Война в Персидском заливе):**  
   Программный комплекс Patriot использовал числа двойной точности для расчетов времени. Ошибка в точности накопилась за несколько часов, что привело к неправильному расчету траектории ракеты и, как следствие, трагедии. Подробнее описано на [сайте IMA](https://www.ima.umn.edu/~arnold/disasters/patriot.html).
