...
## Что там под капотом у .NET {id="net_1"}
...
- **Статическая сборка** (EXE): Это исполняемый файл, который можно запустить как самостоятельную программу. Обычно имеет расширение `.exe`.
...
Ну вот! Если вы дочитали это, то вам приз! Запустите проект `ex0049_snake`. Чтобы управлять змейкой используйте клавиши стрелок.
...
### **1. Основы сравнения строк** {id="1_1"}
...
### **2. Сравнение строк через операторы `==` и `!=`** {id="2_1"}
...
### **3. Как строки сравниваются на уровне реализации?** {id="3_1"}
...
### **5. Сравнение строк с помощью методов**
...
### **6. Сравнение строк и других объектов**
...
специализированных методов. Разработчики могут использовать простые операторы для сравнения значений и 
